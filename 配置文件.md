...
context:
  ...
  max_device_memory: "59GB"  # 59GB for 910B
  save_graphs: False
  device_id: 0

# aicc
remote_save_url: "obs://zzaa/competition/glm2/output-test/"
...
train_dataset: &train_dataset
  data_loader:
    ...
    dataset_dir: "/home/ma-user/work/chatglm2_6b_lora/train.jsonl"
    shuffle: True
    phase: "train"
    version: 2
    origin_columns: ["input", "output"]
  tokenizer:
    type: ChatGLM2Tokenizer
...
seed: 0
run_mode: 'train'
output_dir: '/home/ma-user/work/output'  # 当前不支持自定义修改，请勿修改该默认值
load_checkpoint: '/home/ma-user/work/ma-user-work/checkpoint/rank_0/glm2_6b.ckpt'
auto_trans_ckpt: False  # If true, auto transform load_checkpoint to load in distributed model
only_save_strategy: False
resume_training: False
...
# aicc
remote_save_url: "obs://amii/competition/glm2/output-test/"
