                ...
                <div ref="chatContainer" class="react-scroll-to-bottom--css-krija-1n7m0yu">
                  <div class="flex flex-col items-center text-sm dark:bg-gray-800">
                    ...
                    <template v-for="conv, idx in conversation">
                            ...
                            <div class="relative flex">
                              <span
                                ...
                                <span
                                  ...
                                  <img aria-hidden="true" :src="require('./assets/imgs/human.png')" alt="huamn"
                      ...
                      <div v-if="conv.speaker == 'diagnosis'" class="result-box">
                        <h2>诊断结果:</h2>
                        <!-- <p><strong>患者姓名:</strong> {{ diagnosisResult.patientName }}</p>
                        <p><strong>症状:</strong> {{ diagnosisResult.symptoms }}</p> -->
                        <p><strong>诊断:</strong> {{ diagnosisResult.diagnosis }}</p>
                      </div>
                      <!-- ai -->
                        ...
                        <div
                          ...
                          <div class="w-[30px] flex flex-col relative items-end">
                            <div
                              ...
                              <span
                                style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;">
                                <img aria-hidden="true" :src="require('./assets/imgs/favicon-32x32.png')" alt="huamn"
                                  style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;">
                              </span>
                            </div>
            ...
            <div
              ...
              <form class="stretch mx-2 flex flex-row gap-3 pt-2 last:mb-2 md:last:mb-6 lg:mx-auto lg:max-w-3xl lg:pt-6">
                <div class="relative flex h-full flex-1 md:flex-col">
                  ...
                  <div style="display: flex;" class="geebar">
                    <button type="button" class="diagnosis" value="诊断结果" @click.prevent="diagnosis()">诊断结果</button>
                    <div
...
export default {
  ...
  methods: {
    ...
    getToken() {
      axios.post('http://localhost:5000/queryToken')
        .then(res => {
          console.log(res)
          this.token = res.data
        })
    ...
    send() {
      ...
      request.post('http://localhost:5000/queryResponse', formdata)
        .then((result) => {
        ...
        .catch((err) => {
          // conv["speeches"][0] += "Sorry, I can't understand you."
          // that.refrechConversation();
        });
    ...
    diagnosis() {
      ...
      var that = this;
      let formdata = new FormData();
      formdata.append("prompt", chatMsg + this.history);
      console.log(chatMsg + this.history)
      formdata.append("history", '');
      axios.post('http://localhost:5000/queryResponse', formdata)
        .then((result) => {
          console.log(result);
          // var resp = result.data;
          // this.history = resp.data.history
          // var answer = resp.data.response;
          // conv["speeches"][0] += answer
          // that.refrechConversation();

          this.diagnosisResult['diagnosis'] = result.data.response
